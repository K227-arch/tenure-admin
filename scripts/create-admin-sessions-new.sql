-- ============================================
-- Create admin_sessions and admin_activity_logs tables
-- ============================================

BEGIN;

-- Step 1: Create new admin_sessions table
...
-- Step 3: Create admin_activity_logs table
...
-- Step 4: Create indexes for admin_activity_logs
...
-- Step 6: Create view for active sessions
...
-- Step 7: Create view for session history
...
-- Step 8: Create function to log admin activity
...
-- Step 9: Create function to cleanup expired sessions
...
-- Step 10: Create function to get admin session stats
...
SELECT '✅ admin_sessions and admin_activity_logs tables created successfully!' as status;
